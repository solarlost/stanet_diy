...
# ==============================================================================
# SE-IB-STA-Net: SE Blocks + Information Bottleneck + Alignment
# ==============================================================================
...
class conv_block_se(keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        eeg_feature = self.eeg_se(eeg_feature)
        ...
        fnirs_feature = self.fnirs_se(fnirs_feature)
        ...
        eegfusion_feature = self.eegfusion_se(eegfusion_feature)
...
def sta_net_se_ib(latent_dim=128, beta=1e-3, align_weight=0.1):
    """
    SE-IB-STA-Net: SE Blocks + IB + Alignment
    """
    ...
    model = keras.Model(inputs=[eeg_input, fnirs_input], outputs=[the_pred, eeg_pred], name="sta_net_se_ib")
